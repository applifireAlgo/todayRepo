 ...
 * 
 */
Ext.define('Projone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Projone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
