...
Ext
		.define(
				'Projone.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Projone.view.logger.tabs.details.DetailsTab',
							'Projone.view.logger.tabs.fileconnector.FileConnectorTab',
							'Projone.view.logger.tabs.dbconnector.DBConnectorTab',
							'Projone.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Projone.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Projone.view.logger.LogConfigurationTabPanelController',
