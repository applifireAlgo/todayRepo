Ext.define("Projone.view.clouddrive.CloudDrive", {
	extend : 'Ext.panel.Panel',
	xtype : 'clouddrive',
	requires : [ 'Projone.view.clouddrive.CloudDriveController',
	             'Projone.view.clouddrive.documentview.DocumentsView',
	             'Projone.view.clouddrive.drivedetails.DriveDetails',
	             //'Projone.view.clouddrive.documentview.DocumentListView'
	             ],
