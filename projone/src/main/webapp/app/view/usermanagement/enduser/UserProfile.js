Ext.define('Projone.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Projone.view.usermanagement.enduser.UserProfileController', 'Projone.view.usermanagement.admin.AddUserDetailsViewModel', 'Projone.model.AddUserDataModel' ],
