Ext.define('Projone.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Projone.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
