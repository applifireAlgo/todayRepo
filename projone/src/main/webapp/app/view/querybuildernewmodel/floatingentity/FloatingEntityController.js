Ext.define('Projone.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Projone.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Projone.view.querybuildernewmodel.queryentitiesjoins.Query',
