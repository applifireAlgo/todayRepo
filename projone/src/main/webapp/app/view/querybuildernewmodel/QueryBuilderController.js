Ext.define('Projone.view.querybuildernewmodel.QueryBuilderController', {
	extend : 'Ext.app.ViewController',
	alias : 'controller.query-builder',
	requires:['Projone.view.querybuildernewmodel.queryentitiesjoins.QueryFieldsStore',
	          'Projone.view.querybuildernewmodel.queryentitiesjoins.QueryEntitiesStore',
	          'Projone.view.querybuildernewmodel.queryentitiesjoins.EntityJoinStore',
	...
	openQueryDetailWindow : function(saveBtn){
		...
		var queryWindow = Ext.create('Projone.view.querybuildernewmodel.querydetail.QueryDetail');
