Ext.define('Projone.view.querybuildernewmodel.queryentities.QueryEntitiesTree', {
	extend : 'Ext.tree.TreePanel',
	requires:['Projone.view.querybuildernewmodel.queryentities.QueryEntitiesController'],
