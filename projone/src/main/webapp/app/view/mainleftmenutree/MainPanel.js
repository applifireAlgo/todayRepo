Ext.define('Projone.view.mainleftmenutree.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithLeftMenu',

	requires : [ 'Projone.view.resource.ResourcePanel',
			'Projone.view.mainleftmenutree.TopPanel.TopPanel',
			'Ext.layout.container.Accordion', 'Ext.Img', 'Ext.button.Split',
			'Projone.view.resource.DockedResourcePanel','Projone.view.fw.mainViewPanel.MainPanelController' ],
