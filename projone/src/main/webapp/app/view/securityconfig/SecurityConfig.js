 ...
 * 
 */
Ext.define('Projone.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Projone.view.securityconfig.SecurityConfigController',
			'Projone.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
