Ext.define('Projone.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Projone.view.reportui.datachart.chart.RatingField','Projone.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
