...
Ext.define('Projone.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Projone.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Projone.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
