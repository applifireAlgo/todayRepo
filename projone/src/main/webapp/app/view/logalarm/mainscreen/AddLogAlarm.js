 ...
 * 
 */
Ext.define('Projone.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Projone.view.logalarm.mainscreen.AddLogAlarmController',
			'Projone.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Projone.view.logalarm.mainscreen.AppAlarmPanel',
