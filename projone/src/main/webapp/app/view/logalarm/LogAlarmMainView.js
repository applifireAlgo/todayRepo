 ...
 * 
 */
Ext.define('Projone.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Projone.view.logalarm.LogAlarmMainViewController',
			'Projone.view.logalarm.tree.LogAlarmTreePanel',
			'Projone.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
