Ext.define('Projone.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Projone.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Projone.view.reportbuilder.gridconfig.GridConfigView',
	           'Projone.view.reportbuilder.properties.PropertiesPanelView',
	           'Projone.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
