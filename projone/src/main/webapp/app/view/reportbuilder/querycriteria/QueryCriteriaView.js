Ext.define('Projone.view.reportbuilder.querycriteria.QueryCriteriaView', {
	extend : 'Ext.grid.Panel',
	requires:['Projone.view.reportbuilder.querycriteria.QueryCriteriaController',
	          'Projone.store.QueryCriteriaWidgetsStore',
	          'Ext.grid.RowEditor',
	          'Projone.view.reportbuilder.querycriteria.QueryCriteriaModel'
	          ],
	...
	columns : [
				...
				},
				{
					...
					editor : {
						...
						store : 'Projone.store.QueryCriteriaWidgetsStore',
						queryMode : 'local',
						forceSelection : true,
						triggerAction : 'all',
						selectOnFocus : true,
