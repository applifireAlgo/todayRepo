Ext.define('Projone.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Projone.view.reportbuilder.reportlist.ReportListPanelView',
             'Projone.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Projone.view.reportbuilder.mainview.ReportMainController'
             ],
