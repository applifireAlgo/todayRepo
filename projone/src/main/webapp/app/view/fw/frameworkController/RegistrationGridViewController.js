Ext.define('Projone.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Projone.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Projone.view.console.ConsoleWindow');
