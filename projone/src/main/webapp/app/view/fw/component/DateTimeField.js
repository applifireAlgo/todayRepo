 ...
 */
Ext.define('Projone.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Projone.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Projone.view.fw.component.DateTimePicker(o);
    },
