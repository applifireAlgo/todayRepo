Ext
		.define(
				'Projone.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Projone.view.searchengine.search.SearchEngineMainPanelController','Projone.view.searchengine.search.PanelHeaderField' ,'Projone.view.searchengine.search.ReportGridView','Projone.view.searchengine.search.ReportChartView','Projone.view.searchengine.search.documentView','Projone.view.searchengine.search.DouMeanView','Projone.view.googlemaps.map.MapPanel'],
