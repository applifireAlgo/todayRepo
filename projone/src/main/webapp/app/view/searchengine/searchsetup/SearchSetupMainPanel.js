 ...
 * 
 */
Ext.define('Projone.view.searchengine.searchsetup.SearchSetupMainPanel', 
{
	extend : 'Ext.panel.Panel',
	xtype : 'searchsetup',
	requires : [ 'Ext.layout.container.HBox', 'Ext.layout.container.VBox', 'Projone.view.searchengine.searchsetup.SearchSetupMainPanelController',
	             'Projone.view.searchengine.searchsetup.ChartFieldsModel',
	           ],
