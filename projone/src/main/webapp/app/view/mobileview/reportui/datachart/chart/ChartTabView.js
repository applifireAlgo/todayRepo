Ext.define('Projone.view.mobileview.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Projone.view.mobileview.reportui.datachart.chart.RatingField','Projone.view.mobileview.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
