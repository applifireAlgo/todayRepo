package projone.app.server.repository.aspect;
...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* projone.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* projone.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* projone.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* projone.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* projone.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* projone.app.server.repository..*(..))")
