package projone.app.shared.location;
...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "AddressExtended", complexity = Complexity.LOW)
...
public class AddressExtended implements Serializable, CommonEntityInterface, Comparator<AddressExtended> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.location.AddressExtended other = (projone.app.shared.location.AddressExtended) obj;
            if (addExtId == null) {
                return false;
