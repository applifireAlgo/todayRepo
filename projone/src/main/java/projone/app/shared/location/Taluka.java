...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "Taluka", complexity = Complexity.LOW)
...
public class Taluka implements Serializable, CommonEntityInterface, Comparator<Taluka> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.location.Taluka other = (projone.app.shared.location.Taluka) obj;
            if (talukaId == null) {
                return false;
