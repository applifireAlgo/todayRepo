...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "UserRoleBridge", complexity = Complexity.LOW)
...
public class UserRoleBridge implements Serializable, CommonEntityInterface, Comparator<UserRoleBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.authorization.UserRoleBridge other = (projone.app.shared.authorization.UserRoleBridge) obj;
            if (roleUserMapId == null) {
                return false;
