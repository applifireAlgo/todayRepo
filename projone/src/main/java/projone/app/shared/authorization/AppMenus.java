...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "AppMenus", complexity = Complexity.LOW)
...
public class AppMenus implements Serializable, CommonEntityInterface, Comparator<AppMenus> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.authorization.AppMenus other = (projone.app.shared.authorization.AppMenus) obj;
            if (menuId == null) {
                return false;
