...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "a@y.co", versionNumber = "3", comments = "RoleMenuBridge", complexity = Complexity.LOW)
...
public class RoleMenuBridge implements Serializable, CommonEntityInterface, Comparator<RoleMenuBridge> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.authorization.RoleMenuBridge other = (projone.app.shared.authorization.RoleMenuBridge) obj;
            if (roleMenuMapId == null) {
                return false;
