package projone.app.shared.customers;
...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "AppCustomerCategory", complexity = Complexity.LOW)
...
public class AppCustomerCategory implements Serializable, CommonEntityInterface, Comparator<AppCustomerCategory> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.customers.AppCustomerCategory other = (projone.app.shared.customers.AppCustomerCategory) obj;
            if (appcustCategoryId == null) {
                return false;
