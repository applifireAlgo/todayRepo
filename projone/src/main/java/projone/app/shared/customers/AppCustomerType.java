...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "AppCustomerType", complexity = Complexity.LOW)
...
public class AppCustomerType implements Serializable, CommonEntityInterface, Comparator<AppCustomerType> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.customers.AppCustomerType other = (projone.app.shared.customers.AppCustomerType) obj;
            if (appcustTypeId == null) {
                return false;
