...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "CommunicationData", complexity = Complexity.LOW)
...
public class CommunicationData implements Serializable, CommonEntityInterface, Comparator<CommunicationData> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.contacts.CommunicationData other = (projone.app.shared.contacts.CommunicationData) obj;
            if (commDataId == null) {
                return false;
