...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "Title", complexity = Complexity.LOW)
...
public class Title implements Serializable, CommonEntityInterface, Comparator<Title> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.contacts.Title other = (projone.app.shared.contacts.Title) obj;
            if (titleId == null) {
                return false;
