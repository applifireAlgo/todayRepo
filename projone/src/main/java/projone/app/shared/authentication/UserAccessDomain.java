...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "UserAccessDomain", complexity = Complexity.LOW)
...
public class UserAccessDomain implements Serializable, CommonEntityInterface, Comparator<UserAccessDomain> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.authentication.UserAccessDomain other = (projone.app.shared.authentication.UserAccessDomain) obj;
            if (userAccessDomainId == null) {
                return false;
