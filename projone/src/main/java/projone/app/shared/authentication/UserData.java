...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "a@y.co", versionNumber = "2", comments = "UserData", complexity = Complexity.LOW)
...
public class UserData implements Serializable, CommonEntityInterface, UserDataInterface, Comparator<UserData> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.authentication.UserData other = (projone.app.shared.authentication.UserData) obj;
            if (userDataId == null) {
                return false;
