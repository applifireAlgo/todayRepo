...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "", versionNumber = "1", comments = "LoginSession", complexity = Complexity.LOW)
public class LoginSession implements Serializable, CommonEntityInterface, LoginSessionInterface, Comparator<LoginSession> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.authentication.LoginSession other = (projone.app.shared.authentication.LoginSession) obj;
            if (appSessionId == null) {
                return false;
