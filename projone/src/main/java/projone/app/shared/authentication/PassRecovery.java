...
@SourceCodeAuthorClass(createdBy = "a@y.co", updatedBy = "a@y.co", versionNumber = "3", comments = "PassRecovery", complexity = Complexity.LOW)
...
public class PassRecovery implements Serializable, CommonEntityInterface, PassRecoveryInterface, Comparator<PassRecovery> {
    ...
    public boolean equals(Object obj) {
        try {
            projone.app.shared.authentication.PassRecovery other = (projone.app.shared.authentication.PassRecovery) obj;
            if (passRecoveryId == null) {
                return false;
